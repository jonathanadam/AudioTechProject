...
//static int threadFunctionWriteToFile(void* ptr)
//{
...
//        if ((availableBytes >= pData->ringBuffer.length / NUM_WRITES_PER_BUFFER) || pData->threadSyncFlag)
//        {
////            void* ptr[2] = 0; // basically start writing
//            
//            
...
////    {
////        int* available;
////        void* bufferStart = TPCircularBufferHead(ringBuffer, available);
...
//    }
//    
//    if (! TPCircularBufferInit(&data.ringBuffer, sizeof(SAMPLE)*numSamples))
//    {
//        printf("Failed to initialize ring buffer. Stuff failed ??\n");
//        goto done;
//    }
//    
//    err = Pa_Initialize();
